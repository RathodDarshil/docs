...
If you are using Expo, you will need to use development builds since this package relies on native libraries. Follow the [Expo Development Builds Documentation](https://docs.expo.io/workflow/development-builds/) to get started.

## Next Steps

After installation, proceed to the [Usage Guide](/sdk/react-native/usage) to learn how to initialize and use the SDK in your application.
