...
![Custom Store Listings](/images/store-listings-dashboard.png)
...
1. Go to [https://www.linkrunner.io/settings?s=store-listings](https://www.linkrunner.io/settings?s=store-listings)
